...
* [ ] Need to either add a readme in the directories or fix asciidoc to deal with asciidoc not showing in github
...
*** [x] only build scad files and only run container with scad files
